...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    name: "Sourav Mishra",
    category: "Coach",
    image: "https://raw.githubusercontent.com/scale100million-prog/my-images/main/coach_portrait_1780308902426.png",
    before: "Account at ZERO",
    after: "Consistent Rs.3L+/month",
    story: "Sourav's entire business was built on Instagram — 10,000 followers, 1 to 2 lakhs a month through DMs and content. Then his account got disabled in one day and everything became zero overnight. We built his entire client acquisition system from the ground up — a funnel that does not depend on followers, Meta ads that bring in leads daily, and a follow-up system that converts cold traffic into booked calls. Today his business is more stable than ever, with leads coming in every day whether he posts or not."
  },
  {
    id: 4,
    ...
    before: "Rs.3L/month",
    after: "Rs.12L/month (4x growth)",
    story: "PowerPro is a performance marketing agency that delivered results for clients but struggled to scale its own pipeline. Leads were inconsistent and Prashant spent too much time on outreach. We built a complete acquisition system, positioning the agency around measurable outcomes, a results-driven funnel, and Meta ads that booked qualified prospects. PowerPro scaled 4x on a system that runs without manual outreach."
  },
  {
    id: 5,
    name: "Sula",
    ...
    before: "Rs.2L/month",
    after: "Rs.6L/month (3x growth)",
    story: "Sula was making Rs.2 lakh a month through referrals and organic reach. She had the results and the skill but no system to bring in clients predictably. We built her funnel, launched her Meta ads, and set up follow-up automation that kept leads warm until they booked. Over 6 months her revenue tripled, no longer dependent on referrals."
  },
  {
    id: 6,
    name: "Swar Yoga",
    ...
    before: "Rs.2L/month",
    after: "Rs.8L/month (4x growth)",
    story: "Swar Yoga had a powerful practice but the business side lagged behind. Leads were inconsistent and the team spent too much time on outreach instead of teaching. We built the entire acquisition system — offer positioning, VSL script and funnel, Meta ads targeting people searching for life transformation through yoga, and a follow-up sequence that lifted show-up rates. The result was 4x revenue growth with a pipeline that runs independently of manual marketing effort."
  }
];
